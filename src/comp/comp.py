...
f = [(human.name, human.age) for human in humans if human.age in [27, 28, 29, 30, 31, 32]]
print(f)
...
def combine(human):
  copy = Human(human.name.upper(), human.age + 5)
  return copy

print("All names uppercase:")
g = [combine(human) for human in humans]
print(g)
